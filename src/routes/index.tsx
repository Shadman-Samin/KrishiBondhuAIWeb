  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6">
        <div
          className={`flex items-center justify-between rounded-full px-5 py-2.5 transition-all ${scrolled ? "glass shadow-card" : ""}`}
        >
          <a
            href="#"
            onClick={(e) => {
          ...
          <nav ref={navRef} className="hidden md:flex relative items-center gap-1 text-sm">
            <div
              className="absolute top-1/2 -translate-y-1/2 h-9 rounded-full glass border border-border/60 transition-all duration-300 ease-out"
              style={{
                left: pillStyle.left,
